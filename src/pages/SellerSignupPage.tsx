      ...
      <div className="bg-white py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900">Why Join WoodHeat?</h2>
            <p className="mt-4 text-lg text-gray-600">
              Start growing your business with these exclusive benefits
            </p>
          </div>
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div className="ml-3">
                    ...
                    <p className="mt-2 text-gray-600">Only pay when you receive orders. Keep 100% of delivery fees.</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <CheckCircle className="h-6 w-6 text-green-500 mt-0.5" />
                  <div className="ml-3">
                    <h3 className="text-lg font-medium text-gray-900">Simple Pricing</h3>
                    <p className="mt-2 text-gray-600">First 3 orders free, then just $10 per order. Cancel anytime.</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <CheckCircle className="h-6 w-6 text-green-500 mt-0.5" />
                  <div className="ml-3">
                    ...
                    <p className="mt-2 text-gray-600">Accept credit card payments safely through Stripe's platform.</p>
                  </div>
                </div>
              </div>
            </div>
