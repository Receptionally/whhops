...
export function ChargeModal({ isOpen, onClose, order }: ChargeModalProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!order.stripe_customer_id || !order.stripe_account_id) {
        throw new Error('Missing required Stripe information');
      }
      ...
      await chargeCustomer({
        ...
        amount: numAmount,
        description: `Additional charge for order ${order.id}`,
      });
