...
import { trackAddressSearch } from '../services/analytics/search';
...
export function AddressSearch() {
  ...
  const handleSearch = () => {
    ...
    const searchAddress = selectedAddress || address;
    sessionStorage.setItem('delivery_address', searchAddress);
    navigate(`/firewood-near-me?address=${encodeURIComponent(searchAddress)}`);
  };
