...
function SetupPaymentFormContent({ clientSecret, onSuccess, onClose }: SetupPaymentFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      logger.info('Successfully set up payment method');
      onSuccess();
    } catch (err) {
...
export function SetupPaymentModal({ clientSecret, onSuccess, onClose }: SetupPaymentModalProps) {
  return (
