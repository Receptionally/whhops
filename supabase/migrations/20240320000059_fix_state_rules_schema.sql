-- Drop existing state rules table and related objects
drop table if exists public.state_rules cascade;
drop function if exists public.update_updated_at_column cascade;
drop function if exists public.check_transport_rules cascade;
drop function if exists public.get_allowed_transport_states cascade;

-- Create state_rules table with proper schema
