-- First, disable stacking for any sellers who have it enabled but no max distance
update public.sellers
set provides_stacking = false,
...
-- Update handle_new_user function to ensure proper defaults
