-- Drop and recreate state_rules table with all fields
...
create index if not exists idx_state_rules_max_transport_miles on public.state_rules(max_transport_miles);
