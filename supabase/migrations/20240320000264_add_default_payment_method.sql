-- Add default payment method field to sellers table
alter table public.sellers
  add column if not exists default_payment_method text;

-- Update seller subscription status view to include payment method
...
-- Update setup intent function to store default payment method
