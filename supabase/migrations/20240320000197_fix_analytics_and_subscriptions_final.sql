...
drop function if exists check_seller_subscription cascade;
drop function if exists track_seller_pageview cascade;
drop function if exists track_seller_search_appearance cascade;

-- Add subscription and analytics fields to sellers table
